...
namespace Wikimedia.Utilities.Services
{
    public class WikidataService : IWikidataService
    {
        ...
        public IEnumerable<WikidataItemDto> GetItemsPerDeathDate(DateTime deathDate, bool coreFieldsOnly)
        {
            string uri = GetUrlWikidataQueryDeceasedPerDate(deathDate, coreFieldsOnly);
            var jsonString = client.GetStringAsync(uri).Result;
        ...
        public string GetUrlWikidataQueryDeceasedPerDate(DateTime date, bool coreFieldsOnly)
        {
            /*
                An url-encoded query is returned. Run the sparql SQL in https://query.wikidata.org/ and then selecting '</> code'; tab URL
                Queries are shortened by removing duplicate spaces ('%20%20' -> '%20') and removing line feeds ('%0A' -> ''). Exceptions (not replaced):
                '%0AWITH'
                '%0AWHERE'
            */
            return coreFieldsOnly ? GetUrlQueryDeceasedPerDateCoreFields(date) : GetUrlQueryDeceasedPerDateAllFields(date);
        }

        private string GetUrlQueryDeceasedPerDateCoreFields(DateTime date)
        {
            return @"https://query.wikidata.org/sparql?query=" +
                   @"SELECT%20%3Fitem%20%3Farticlename%20%3FitemLabel%20%3FitemDescription%20%3Fsl%20%3Fdod%0AWHERE%20%7B%20VALUES%20%3Fdod%20%7B%22%2B2001-08-25%22%5E%5Exsd%3AdateTime%7D%20%3Fdod%20%5Ewdt%3AP570%20%3Fitem%20.%20%3Fitem%20wikibase%3Asitelinks%20%3Fsl%20.%20%3Fitem%20%5Eschema%3Aabout%20%3Farticle%20.%20%3Farticle%20schema%3AisPartOf%20%3Chttps%3A%2F%2Fen.wikipedia.org%2F%3E%3B%20schema%3Aname%20%3Farticlename%20.%20OPTIONAL%20%7B%20%3Fitem%20p%3AP570%20%3Fdod_stm%20.%20%3Fdod_stm%20ps%3AP570%20%3Fdod%20%3B%20psv%3AP570%20%5Bwikibase%3AtimePrecision%20%3Fdod_precision%5D.%20FILTER(%20%3Fdod_precision%20%3E%3D%20%2211%22%5E%5Exsd%3Ainteger%20)%20%7D%20SERVICE%20wikibase%3Alabel%20%7B%20bd%3AserviceParam%20wikibase%3Alanguage%20%22en%22%20.%20%3Fitem%20rdfs%3Alabel%20%3FitemLabel%20.%20%3Fitem%20schema%3Adescription%20%3FitemDescription%20.%20%7D%20BIND(REPLACE(%3FitemLabel%2C%20%22%5E.*(%3F%3C!%20%5BVv%5D%5Bao%5Dn%7C%20%5BDd%5D%5Baeiu%5D%7C%20%5BDd%5D%5Be%5D%5Blns%5D%7C%20%5BLl%5D%5Bae%5D)%20(%3F!(%5BSJ%5Dr%5C%5C.%3F%7C%5BXVI%5D%2B)%24)%22%2C%20%22%22)%20AS%20%3Fsortname)%20%7D%20ORDER%20BY%20ASC(UCASE(%3Fsortname))%20ASC(UCASE(%3FitemLabel))" +
                   @"&format=json";
        }
